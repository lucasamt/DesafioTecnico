      ...
      <Flex
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
          ...
          <Flex display={{base: 'none', md: 'flex'}} ml={0}>
            ...
            <LinkNav to='/home'>
              <Button variant="light">Qyon Advanced Works</Button>
            </LinkNav>
...
const NAV_ITEMS = [
  ...
  {
    label: 'Cadastrar Competidor',
    href: '/competidores',
  },

  {
    label: 'Alterar Competidor',
    href: '/alterarcompetidor',
  },

  {
    label: 'Excluir Competidor',
    href: '/excluircompetidor',
  },
